...
async function onSubmit() {
  ...
  const res = await fetch("/.netlify/functions/cp-notify-lead", {
    method: "POST",
  ...
  window.location.href = "/realestate/cp/thank-you";
}

useHead({
  title: "Download Cody Posey’s Real Estate Guide",
  meta: [{ name: "description", content: "Get your free Buy, Sell & Relocation guide from Cody Posey." }],
});
</script>
